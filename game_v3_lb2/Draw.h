...
#define RedneckPNG "../texture/Gopnik.png"
#define CarPNG "../texture/Car.png"
#define Power_DrinkPNG "../texture/PowerDrink.png"
#define Apple_treePNG "../texture/Apple_tree.png"
